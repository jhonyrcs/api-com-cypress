describe('Atualizar objeto parcialmente', () => {
    let objectId;

    before(() => {
        // Antes de cada teste, é criado um novo objeto para atualizar
        cy.api({
            method: 'POST',
    ...
    it('Deve atualizar um objeto existente', () => {
        // Fazemos a chamada PATCH para atualizar o objeto
        cy.api({
            method: 'PATCH',
